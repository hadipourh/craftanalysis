...
double verify(int R, int N1, int N2, int N3) {
	...
	{	        
        //0xAA000000AA00AAA0
        uint8_t dp[16] = {0x0, 0xA, 0xA, 0xA, 0x0, 0x0, 0xA, 0xA, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xA, 0xA};
        //0x0A0005000A0000A0
        uint8_t dc[16] = {0x0, 0xA, 0x0, 0x0, 0x0, 0x0, 0xA, 0x0, 0x0, 0x0, 0x5, 0x0, 0x0, 0x0, 0xA, 0x0};
		int j;
		int num = 0;
		for(j=0; j < N2; j++) {

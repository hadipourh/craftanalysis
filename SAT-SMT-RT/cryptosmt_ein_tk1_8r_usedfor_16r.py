...
from ciphers import (craft, craftrtk, craftrtk1, craftrtk2, craftlinear, ein_tk2_7r)
...
def startsearch(tool_parameters):
    ...
    if tool_parameters["mode"] == 0:
        ...
        fileobj = open("tk1_possible_outputs_16r.txt", 'r')
        possible_inputs = fileobj.readlines()
        fileobj.close()
        fileobj = open("result_ein_tk1_8r_outof_16r.txt", "w")
        ...
        for i in range(len(possible_inputs)):
            ...
            tool_parameters["fixedVariables"]["x8"] = possible_inputs[i][0:-1]

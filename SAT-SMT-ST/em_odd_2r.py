...
from ciphers import (craft, craftrtk, craftrtk1, craftrtk2, craftrtk3, craftlinear, ein_even, em_even, eout_even, 
                    ein_odd, em_odd, eout_odd, ein_even_6r)
...
def startsearch(tool_parameters):
    ...
    if tool_parameters["mode"] == 0:
        ...
        fileobj.close()        
        fileobj = open("result_em_odd_2r.txt", "w")
        ...
        for i in range(len_of_possible_ios):                       
            for j in range(len_of_possible_ios):
                ...
                tool_parameters["fixedVariables"]["z2"] = possible_inputs[j][0:-1]

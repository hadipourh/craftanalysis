...
Copyright (C) May 27, 2019  Hosein Hadipour
...
class CraftCipherLinear(AbstractCipher):
    ...
    # reduced product of sum representation of square of LAT of craft's sbox
    # square of LAT is considered as a boolean function like this f(di, do, corr^2) = b in {0, 1}
